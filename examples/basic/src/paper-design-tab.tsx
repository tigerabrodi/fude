      ...
      <div className="max-w-[540px]">
        <SmartTextbox
          ...
          classNames={{
            ...
            dropdownItem:
              'rounded-[7px] px-[10px] py-2 text-[13px] text-[#AAAAAA] hover:bg-[#1E1E1E] aria-selected:bg-[#1E1E1E] font-[Geist_Mono,JetBrains_Mono,ui-monospace,monospace]',
            tooltip:
              'bg-[#1A1A1A] border border-[#2A2A2A] rounded-[6px] px-2 py-1 text-xs text-[#999999] font-[Geist_Mono,JetBrains_Mono,ui-monospace,monospace]',
          }}
        />
      </div>
