...
describe('focus behavior', () => {
  it('moves caret to end on keyboard focus', async () => {
    const value: Array<Segment> = [{ type: 'text', value: 'hello world' }]
    const { container } = render(
      <SmartTextbox value={value} onChange={() => {}} />
    )
  ...
  it('preserves click-driven cursor placement on pointer focus', async () => {
    const value: Array<Segment> = [{ type: 'text', value: 'hello world' }]
    const { container } = render(
      <SmartTextbox value={value} onChange={() => {}} />
    )
